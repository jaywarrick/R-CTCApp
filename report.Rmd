...
* Yes: `r length(which(values$stateTable$No.Maybe.Yes == 2))` (`r round(100 * length(which(values$stateTable$No.Maybe.Yes == 2)) / nrow(values$stateTable), digits=1)`%)
...
* Maybe: `r length(which(values$stateTable$No.Maybe.Yes == 1))` (`r round(100 * length(which(values$stateTable$No.Maybe.Yes == 1)) / nrow(values$stateTable), digits=1)`%)

# Saved Output

* `r file.path(savedDataPath, paste0(input$reportName, ".xlsx"))`
